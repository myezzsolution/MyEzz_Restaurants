/**
 * Seed Script: Insert restaurant credentials into Supabase
 * Run once: node seedCredentials.js
...
async function seedCredentials() {
    ...
    if (successCount === restaurant_credentials.length) {
        ...
        console.log('⚠️  Now DELETE restaurant_credentials.json and this script!');
    }
}
